...
'''
conda create --name ConMol --file requirements.txt
...
* **Required Columns:** `canonical_smiles`, `bao_label`, `standard_type`, `standard_units`, `assay_organism`, `assay_tissue`, `standard_relation`, `assay_chembl_id`, `assay_description`, `assay_cell_type`.
...
python run.py --mode finetune \
    ...
    --task_file tasks.npy \                   # Path to task embedding file
